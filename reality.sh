    ...
    "inbounds": [
        {
            ...
            "streamSettings": {
                ...
                "realitySettings": {
                    ...
                    "xver": 0,
                    "serverNames": [
                        "touch.10086.cn/i/mobile/greentip.html"
                    ],
...
EOF
    ...
    IP=$(getIP)
    url="vless://${UUID}@${IP}:${PORT}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=touch.10086.cn/i/mobile/greentip.html&fp=chrome&pbk=${rePublicKey}&sid=${shortId}&type=tcp&headerType=none#$ISP"
